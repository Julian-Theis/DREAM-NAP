...
public class Benchmark_BPIC12_W_all_lfc {

	public static void main(String[] args) {
		try {
			String benchmarkName = "bpic12_work_all_lfc";
			String logFile = "BPIC12\\BPI_Challenge_2012.xes";
			...
			for (int t = 0; t < xlog.size(); t++) {
				...
				for (int i = 0; i < trace.size(); i++) {
					...
					if(activity.contains(filter_logtype)){
						...
						String input = caseId + "," + activity + "_" + lifecycle + "," + timestamp + "," + resource1 + "," + resource2;
						output.add(input);
					}
				}
			}
	...
	private static List<Quant> quantize() {
		String csvFile = "logs/bpic12_a/quantize.csv";
		String line = "";
		String cvsSplitBy = ",";
