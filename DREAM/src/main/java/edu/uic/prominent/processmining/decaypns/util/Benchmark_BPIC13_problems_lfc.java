...
public class Benchmark_BPIC13_problems_lfc {

	public static void main(String[] args) {
		try {
			String benchmarkName = "bpic13_p_lfc";
			String logFile1 = "BPIC13\\BPI_Challenge_2013_open_problems.xes";
			String logFile2 = "BPIC13\\BPI_Challenge_2013_closed_problems.xes";
			...
			for (int t = 0; t < xlog1.size(); t++) {
				...
				for (int i = 0; i < trace.size(); i++) {
					...
					String input = caseId + "," + activity + "_"+ lifecycle + "," + timestamp + "," + resource1 + "," + resource2 + "," + resource3 + "," + resource4 + "," + resource5 + "," + resource6 + "," + resource7+ "," + resource8;
					output.add(input);
				}
			}
