...
public class Benchmark_BPIC13_incidents {

	public static void main(String[] args) {
		try {
			String benchmarkName = "bpic13_i";
			String logFile = "BPI_Challenge_2013_incidents.xes";
			...
			for (int t = 0; t < xlog.size(); t++) {
				...
				for (int i = 0; i < trace.size(); i++) {
					 ...
					 * System.out.println("---------");
					 */
					String input = caseId + "," + activity + 
							//"_" + resource1 + 
							"," + timestamp + "," + resource1 + "," + resource2 + "," + resource3 + "," + resource4 + "," + resource5 + "," + resource6 + "," + resource7;
